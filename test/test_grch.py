...
def index(request):       
    ...
    if (request.method == 'POST'):
        if request.POST.get("button") == "UPLOAD & POPULATE":
            ppValues = {"mail": "a", "title": "a", "type": "a", "head": "a", "author": "a", "nfigures": "a", "ntables": "a", "instruct":"a"}
        ...
        if request.POST.get("button") == "SUBMIT":
            ...
            context = {'logs':"\n".join(logs), "mail":"ashik036"}
            return render(request, '../templates/home.html', context)

                    
       

#mail, title, type, head, author, nfigures, ntables, instruct




    context = {'logs': "", "mail":"ashik036"}
    return render(request, '../templates/home.html', context)
