...
from data_ingestionv1.views import homepage, contact


urlpatterns = [
    path('processv0/', include('data_ingestion.urls')),
    path('process/', include('data_ingestionv1.urls')),
    path('review/', include('assessment.urls')),
    ...
    path('<int:id>', TemplateView.as_view(template_name='home.html'), name='home'), 
